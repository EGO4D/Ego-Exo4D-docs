...
Note that your access credentials will expire in 14 days, so it's important to download the dataset locally and not consume it from AWS. If you need continued access to the dataset after your credentials expire, you can easily renew your license by requesting it again at [ego4d.dev/request/ego4d](https://ego4d.dev/request/ego4d). If previously approved, your access will be immediately re-activated.
