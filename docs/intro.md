...
<img alt="Scenarios overview" src="/img/scenarios.jpg" style={{textAlign: 'center', width: '95%', margin: 20}}></img>
...
<img alt="Dataset overview" src="/img/dataset_overview.jpg" style={{textAlign: 'center', width: '95%', margin: 20}}></img>
