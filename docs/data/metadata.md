...
{
    {
        ...
        // Take Information
        "best_exo": "cam04", // which exo camera shows the task the best (may be null)
        "task_start_sec":  0.28164, // when the task starts relative to the take (not including QR code); may be null
        "task_end_sec": 110.06668, // when the task ends relative to the take (not including QR code); may be null
